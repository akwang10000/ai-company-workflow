...
8. `examples/研发团队-首条闭环示例.md`
9. `examples/tasks/*.md`
10. `governance/postmortem-template.md`
...
7. 交接时参考 `governance/handoff-templates.md`
8. 起任务时参考 `examples/tasks/*.md`
9. hotfix / 复杂 bug 收口时参考 `governance/postmortem-template.md`
10. 涉及产品实现边界时参考 `product/product-implementation.md`
...
1. 缺陷优先级 / 事故分级规则
2. 回归验证模板
3. Ready for Delivery 检查清单
4. 把任务单进一步结构化成可直接被系统消费的 schema
